...
import br.com.jbProjects.processor.selectOperator.handler.AbsHandler;

/**
 * Created by julio.bueno on 21/11/2025.
 */
@Projection(of = Customer.class)
public record CustomerAbsAge(
        @ProjectionField(value = "age", selectHandler = AbsHandler.class) Integer absAge
) {
}
